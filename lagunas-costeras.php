<?php $nombrePagina = 'Lagunas Costeras'; ?>
...
<?php
$consulta = "SELECT nombre, descripcion, clima, flora, fauna, distribucion  FROM ecosistema WHERE id='5'";
$resecosistema = mysqli_query($bd, $consulta);
$mostrardatos = mysqli_fetch_array($resecosistema);
?>

<!-- inicio header -->
<div class="lagunas-costeras text-center">
  <div class="container">
...
<div class="container animated wow bounceIn slow" data-wow-delay="900ms">
  <h2 class="graficaLaguna">Variación de flora, fauna y Temperatura</h2>
...
<div class="container galeria">
  ...
  <div class="row mt-4 text-center">
    <div class="col-md-2">
      <a href="#" data-toggle="modal" data-target="#imagen1"> <img src="img/laguna-pic/laguna.jpg" class="img-fluid mb-4 img-thumbnail" alt=""> </a>
      <div id="imagen1" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <img src="img/laguna.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
    <div class="col-md-2">
      <a href="#" data-toggle="modal" data-target="#imagen2"> <img src="img/laguna-pic/laguna2.jpg" class="img-fluid mb-4 img-thumbnail" alt=""> </a>
      <div id="imagen2" class="modal fade" tabindex="-2" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <img src="img/laguna2.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
    <div class="col-md-2">
      <a href="#" data-toggle="modal" data-target="#imagen3"> <img src="img/laguna-pic/laguna3.jpg" class="img-fluid mb-4 img-thumbnail" alt=""> </a>
      <div id="imagen3" class="modal fade" tabindex="-3" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <img src="img/laguna3.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
    <div class="col-md-2">
      <a href="#" data-toggle="modal" data-target="#imagen4"> <img src="img/laguna-pic/laguna4.jpg" class="img-fluid mb-4 img-thumbnail" alt=""> </a>
      <div id="imagen4" class="modal fade" tabindex="-4" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <img src="img/laguna4.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
    <div class="col-md-2">
      <a href="#" data-toggle="modal" data-target="#imagen5"> <img src="img/laguna-pic/laguna5.jpg" class="img-fluid mb-4 img-thumbnail" alt=""> </a>
      <div id="imagen5" class="modal fade" tabindex="-5" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <img src="img/laguna5.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
    <div class="col-md-2">
      <a href="#" data-toggle="modal" data-target="#imagen6"> <img src="img/laguna-pic/laguna6.jpg" class="img-fluid mb-4 img-thumbnail" alt=""> </a>
      <div id="imagen6" class="modal fade" tabindex="-6" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <img src="img/laguna6.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    </div>
